                ...
                <div className={`${styles.smNavbarContainer} container`}>
                    ...
                    <div className="is-flex is-hidden-touch">
                            ...
                            { data.map(item =>
                                <li key={item.item} className="px-1 mr-2">
                                    {item.anchor 
                                        ...
                                        : <Link href={item.action[lang]} locale={lang}><a className="has-text-black">{item.label[lang]}</a></Link>
                                    }
                                </li>
                            )}
                        </ul>
                        <ul className="is-flex is-align-content-center ml-4">
                            ...
                            <li>
                                <Link href={{pathname: router.pathname, query: router.query}} locale="it">
                            ...
                            { data.map(item =>
                                <li key={item.item} className="px-4 py-2" onClick={() => setMenu(!menu)}>
                                    {item.anchor 
                                        ...
                                        : <Link href={item.action[lang]} locale={lang}><a className="has-text-white title is-4">{item.label[lang]}</a></Link>
                                    }
                                </li>
                            )}
                        </ul>
